...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/10/17 10:12:13 by mlahssin          #+#    #+#              #
#    Updated: 2025/10/21 13:11:38 by mlahssin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
CC = cc
...
BONUS_SRCS = ft_lstadd_back_bonus.c ft_lstclear_bonus.c ft_lstiter_bonus.c \
